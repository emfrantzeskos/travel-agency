...
var RevealOnScroll = function () {
  function RevealOnScroll(listOfItems, waypointOffset) {
  ...
  _createClass(RevealOnScroll, [{
    key: 'hideItemInitially',
    value: function hideItemInitially() {
      this.itemsToReveal.addClass('hide-item');
    }
  }, {
    key: 'createWaypoints',
    value: function createWaypoints(waypointOffset) {
      this.itemsToReveal.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler() {
            (0, _jquery2.default)(currentItem).addClass('hide-item--is-visible');
          }
        });
      });
    }
